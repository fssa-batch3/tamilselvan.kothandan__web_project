...
<body>
    ...
    <section class="doctors">
        ...
        <h1 class="heading">
            Add <span>hospitals</span>
        </h1>

        <div class="box-container">

        </div>
        <button class="btn" id="hospitalAdd">Add Hospital</button>
    ...
    <section class="footer">
        ...
        <a href="../pages/products/hospital details/Apollo hospital details.html"></a>

    </section>
    <script src="../assets/js/logout.js"></script>
    <script src="../assets/js/adminHospitalPage.js"></script>
</body>
